...
import com.nbu.fares.security.AppRoleDataOnDemand;
import com.nbu.fares.security.AppUser;
import com.nbu.fares.security.AppUserDataOnDemand;
...
privileged aspect AppUserDataOnDemand_Roo_DataOnDemand {
    ...
    public void AppUserDataOnDemand.setConfirmpassword(AppUser obj, int index) {
        String confirmpassword = "confirmpassword_" + index;
