...
import com.nbu.fares.domain.LocationDataOnDemand;
...
privileged aspect LocationDataOnDemand_Roo_DataOnDemand {
    ...
    public void LocationDataOnDemand.setCreatedBy(Location obj, int index) {
        String createdBy = "createdBy_" + index;
        obj.setCreatedBy(createdBy);
    }
    
    public void LocationDataOnDemand.setCreatedDate(Location obj, int index) {
        Date createdDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setCreatedDate(createdDate);
    }
    
    public void LocationDataOnDemand.setFileName(Location obj, int index) {
        String fileName = "fileName_" + index;
        obj.setFileName(fileName);
    }
    
    public void LocationDataOnDemand.setLocationCode(Location obj, int index) {
        String locationCode = "locationCode_" + index;
    ...
    public void LocationDataOnDemand.setUpdatedBy(Location obj, int index) {
        String updatedBy = "updatedBy_" + index;
        obj.setUpdatedBy(updatedBy);
    }
    
    public void LocationDataOnDemand.setUpdatedDate(Location obj, int index) {
