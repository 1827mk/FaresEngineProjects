...
import com.nbu.fares.web.LocationController;
...
privileged aspect LocationController_Roo_Controller {
    ...
    void LocationController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("location_createddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("location_updateddate_date_format", "dd/MM/yyyy");
    }
